...
import com.jinhe.myframe.utils.GlideCircleTransform;
...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder setImageUrl(int viewId, Context context, String url) {
        ImageView view = getView(viewId);
        //  Glide.with(context).skipMemoryCache(false).load(url).into(view);
    ...
    public BaseViewHolder setCircleImageUrl(int viewId, Context context, String url){
        ImageView view = getView(viewId);
        //  Glide.with(context).skipMemoryCache(false).load(url).into(view);
        // String newUrl = url.replace("\\", "/");
        Glide
    ...
    public BaseViewHolder setCircleImageUrl(int viewId, Fragment context, String url){
        ImageView view = getView(viewId);
        //  Glide.with(context).skipMemoryCache(false).load(url).into(view);
        // String newUrl = url.replace("\\", "/");
        Glide
    ...
    /*public BaseViewHolder setImageUrls(int viewId, Fragment context, String url) {
        RoundImageView view = getView(viewId);
        //Glide.with(context).load(url).into(view);
        String newUrl = url.replace("\\", "/");
        Glide
                .with(context)
    ...
    public BaseViewHolder setVisible(int viewId, boolean visible, String invisible) {
        View view = getView(viewId);
        if (invisible.equals("INVISIBLE")) {
    ...
    public int VisibleState(int viewId) {
        View view = getView(viewId);
    ...
    /*public BaseViewHolder addSwipeListener(int viewId, SimpleSwipeListener listener) {
        SwipeLayout view = getView(viewId);
        view.addSwipeListener(listener);
        return this;
    }*/
    ...
    public BaseViewHolder setClickable(int viewId,boolean flag){
        View view = getView(viewId);
    ...
    public BaseViewHolder setGridAdapter(GridView mGridView, Adapter adapter) {
        //AdapterView view = getView(viewId);
        mGridView.setAdapter((ListAdapter) adapter);
        return this;
    }

   /* public BaseViewHolder cleanAdapter(int viewId,Adapter adapter){
        if(){
...
*/
    public BaseViewHolder setWidthAndHeight(int viewId, int with, int height) {
        View view = getView(viewId);
