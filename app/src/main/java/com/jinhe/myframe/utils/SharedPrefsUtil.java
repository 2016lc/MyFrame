...
public class SharedPrefsUtil {
    ...
    public static void putValue(Context context, String name, String key,
                                int value) {
        Editor sp = getEditor(context.getApplicationContext(), name);
        sp.putInt(key, value);
        sp.commit();
    }
    ...
    public static int getValue(Context context, String name, String key,
                               int defValue) {
        SharedPreferences sp = getSharedPreferences(context.getApplicationContext(), name);
    ...
    public static void clearValue(Context context, String name, String key){
        Editor sp = getEditor(context.getApplicationContext(), name);
        //sp.putLong(key, value);
        sp.remove(key);
        sp.commit();
    ...
    private static Editor getEditor(Context context, String name) {
        return getSharedPreferences(context.getApplicationContext(), name).edit();
    }
